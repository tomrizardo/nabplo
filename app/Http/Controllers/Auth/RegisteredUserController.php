...
class RegisteredUserController extends Controller
{
    ...
    {
     $recent_app_listing = Municipality::select('name')->where('name','like','%para%')->get()->pluck('name');
    ...
    {   
        ...
        $request->validate([
            ...
            'contact_no' => 'required|numeric|digits:11|unique:user_reports',
            ...
            'email' => 'required|string|email|max:255|unique:user_reports'],[],['reciept_filename' => 'Attachment','addr_municipality'=>'Municipality', 'contact_no' => 'Mobile Number',
