        ...
        <div class="w-screen h-screen">
                    ...
                    >
                        <div class="bg-gray-50">
                            ...
                            >
                                <div
                                    ref="lottieContainer"
                                    class="max-h-full col-span-1 col-start-2 sm:max-h-full"
                                ></div>
                                <div
                                    class="col-span-3 mb-6 text-2xl font-bold text-center text-gray-800 sm:col-span-3"
                                >
                                ...
                                <div class="w-full col-span-3">
                                    <div
                                        class="text-xs font-medium text-left text-gray-600 sm:text-base sm:text-left"
                                    >
                                        I hereby consent the National
                                        Association of the Business Permits and
                                        Licensing Officers (NABPLO) to obtain
                                        and process the information provided for
                                        registration and membership purposes to
                                        the Association and to strictly adhere
                                        to the requirements stated under the
                            ...
                            <div
                                class="items-center justify-between block w-3/4 mx-auto mb-6 sm:flex sm:mb-0"
                            >
                                <PrimaryButton
                                    class="w-full mb-4 text-center bg-white sm:mb-0 rounded-xl sm:mr-6 border-blues text-blues"
                                ...
                                <PrimaryButton
                                    class="w-full text-center rounded-xl bg-blues"
                                    :class="{ 'opacity-25': form.processing }"
                                    :disabled="form.processing"
                                    @click="accept"
                                >
            ...
            <div class="max-w-2xl px-3 mx-auto mt-20 sm:p-0">
                ...
                <form @submit.prevent="submit">
                    <div
                        class="w-full p-1 mx-2 text-sm text-red-500"
                ...
                <hr class="col-span-1 mt-3 bg-gray-200 border-2 sm:col-span-1">
                    ...
                    <div class="mt-4">
                        ...
                        <TextInput
                            ...
                            :class="{
                                'border-red-500': form.errors.contact_no,
                            }"
                            @blur="form.errors.contact_no = false"
                        />
                        <InputError
                            class="mt-2"
