<template>
 ...
 <div class="min-h-[100rem] " v-if="$page.props.staff.staff_info.roles == '1'">


    <div class="p-4 mt-20 text-2xl font-bold text-blues">
        USER SETTINGS
  ...
  <span class="font-medium">Roles Change Successfully</span> 
        ...
        <div class="container p-3 overflow-auto">
            ...
            >
                ...
                <div class="grid grid-cols-6 bg-white max-w-8xl">
                                    ...
                                    <template #default="{row}">
                                     ...
                                     ">Verify
                                               ...
                                               <td
                                                class="px-6 py-4 whitespace-nowrap"
                                            >
                                            <button @click="getResults(row)" class="h-5 px-2 text-sm text-white rounded-md bg-blues w-15">UPDATE</button>
                ...
                <div class="flex justify-between max-w-8xl align-items-center">
