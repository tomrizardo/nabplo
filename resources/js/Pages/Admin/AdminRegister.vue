      ...
      <span v-else>Show</span> 
            ...
            <div class="mt-4">
                <InputLabel for="password_confirmation" value="Confirm Password" />
                  <div class="relative">
    <TextInput id="password_confirmation" :type="passwordFieldType" class="block w-full mt-1" v-model="form.password_confirmation" required autocomplete="new-password" />
    <button type="button" class="absolute transform -translate-y-1/2 top-1/2 right-3" @click="togglePasswordVisibility">
      <span v-if="showPassword">Hide</span>
      <span v-else>Show</span> 
    </button>
...
components:{
GuestLayout,InputError,InputLabel,PrimaryButton,Link,TextInput,Head
