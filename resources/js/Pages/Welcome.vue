...
<div class="relative z-0 w-screen bggg min-h-[34rem] flex items-center justify-center flex-col ">
 ...
 <div class="max-w-lg text-3xl font-bold text-center text-white sm:max-w-4xl sm:text-7xl">
National Association of Business Permits And Licensing Officers 

 </div>
 <div class="mt-2 mb-6 text-2xl font-bold text-center text-white sm:text-6xl sm:max-w-4xl">
    Philippines
 </div>
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum rerum non voluptate, sequi labore recusandae, expedita quam vitae repudiandae tempora modi minus. Praesentium dolorum blanditiis illo? Aperiam quis dolores asperiores.
                    </div> -->
